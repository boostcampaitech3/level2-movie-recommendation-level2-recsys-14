...
def main():
    ...
    # model args
    parser.add_argument("--model_name", default="bert_pretrain", type=str)
    parser.add_argument(
    ...
    user_seq, max_item, _, _, submission_rating_matrix = get_user_seqs(args)
    ...
    submission_dataset = BertDataset(args, user_seq, data_type="submission")
    ...
    # model= torch.load('./output/sas2.pt')
    ...
    generate_submission_file(args.data_file, preds) # 이부분 파일명 수정
