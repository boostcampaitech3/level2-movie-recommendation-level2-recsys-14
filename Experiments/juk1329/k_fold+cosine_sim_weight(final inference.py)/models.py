...
class GatedVAE(Model):
    def __init__(self, args):
        super(GatedVAE, self).__init__(args)
        ...
        self.q_z_logvar = NonLinear(self.args.hidden_size, self.args.z1_size,
    ...
    def forward(self, x):
        ...
        z_q = self.reparameterize(z_q_mean,
                                  z_q_logvar)  # ! train/test distinction -> built into reparameterize function
