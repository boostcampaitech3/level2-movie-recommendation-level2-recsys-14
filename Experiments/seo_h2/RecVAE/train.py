...
parser.add_argument('--model_name', default='recvae_aug2.pt')
parser.add_argument('--train_type', default='train4.csv')
...
for epoch in range(args.n_epochs):
    ...
    "best valid":best_ndcg,
    "train_ndcg@100": train_scores[-1]})
